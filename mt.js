//e: token
function v(e, t, n) {
    return t ? n ? g(t, e) : h(g(t, e)) : n ? m(e) : h(m(e))
}
...
function d(e, t) {
    ...
    for (n = 0; n < e.length; n += 16)
        r = f,
            ...
            f = l(f, p = s(p, h, A, f, e[n + 15], 22, 1236535329), h, A, e[n + 1], 5, -165796510),
            A = l(A, f, p, h, e[n + 6], 9, -1069501632),
            h = l(h, A, f, p, e[n + 11], 14, 643717713),
            p = l(p, h, A, f, e[n], 20, -373897302),
            f = l(f, p, h, A, e[n + 5], 5, -701558691),
            A = l(A, f, p, h, e[n + 10], 9, 38016083),
            h = l(h, A, f, p, e[n + 15], 14, -660478335),
            p = l(p, h, A, f, e[n + 4], 20, -405537848),
            f = l(f, p, h, A, e[n + 9], 5, 568446438),
            A = l(A, f, p, h, e[n + 14], 9, -1019803690),
            h = l(h, A, f, p, e[n + 3], 14, -187363961),
            p = l(p, h, A, f, e[n + 8], 20, 1163531501),
            f = l(f, p, h, A, e[n + 13], 5, -1444681467),
            A = l(A, f, p, h, e[n + 2], 9, -51403784),
            h = l(h, A, f, p, e[n + 7], 14, 1735328473),
            f = c(f, p = l(p, h, A, f, e[n + 12], 20, -1926607734), h, A, e[n + 5], 4, -378558),
            A = c(A, f, p, h, e[n + 8], 11, -2022574463),
            h = c(h, A, f, p, e[n + 11], 16, 1839030562),
            p = c(p, h, A, f, e[n + 14], 23, -35309556),
            f = c(f, p, h, A, e[n + 1], 4, -1530992060),
            A = c(A, f, p, h, e[n + 4], 11, 1272893353),
            h = c(h, A, f, p, e[n + 7], 16, -155497632),
            p = c(p, h, A, f, e[n + 10], 23, -1094730640),
            f = c(f, p, h, A, e[n + 13], 4, 681279174),
            A = c(A, f, p, h, e[n], 11, -358537222),
            h = c(h, A, f, p, e[n + 3], 16, -722521979),
            p = c(p, h, A, f, e[n + 6], 23, 76029189),
            f = c(f, p, h, A, e[n + 9], 4, -640364487),
            A = c(A, f, p, h, e[n + 12], 11, -421815835),
            h = c(h, A, f, p, e[n + 15], 16, 530742520),
            f = u(f, p = c(p, h, A, f, e[n + 2], 23, -995338651), h, A, e[n], 6, -198630844),
